            ...
            <div className="w-full max-w-[520px] my-[28px] px-[45px] py-[28px] bg-[#fff] rounded-[10px] flex flex-col justify-center items-center">
                ...
                <div class="w-full max-w-[450px] mt-[28px]  rounded-[10px]">
                    <form action="" class=" flex flex-col gap-[10px]">
                        ...
                        {/* Email */}
                        <label htmlFor="" class="mb-[-4px] text-[#090040]">Email</label>
                        <input type="email" name="email" title="Enter your email here!" class="w-full px-[16px] py-[10px] border-2 border-[#d2b4e7] focus:border-[#471396] rounded-[10px] focus:outline-none transition-all duration-300 focus:bg-[#e4e0e8]" placeholder="Enter your email here!" required />
                        ...
                        <span className="flex flex-row justify-end items-center ">
                            ...
                            <a title="Send email via google!" type="submit" class=" flex flex-row items-center mt-[6px] gap-[14px] text-[18px] font-medium border-2 border-[#d2b4e7] px-[16px] py-[10px] rounded-[10px] transition-colors duration-300 cursor-pointer  hover:bg-[#d2b4e7] ">
                                Send Email
                                <MdEmail size={22} />
                            </a>
