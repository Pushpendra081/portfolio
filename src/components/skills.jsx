        ...
        <div className="text-[#fff] mx-[42px] justify-items-center mt-[86px]">
            ...
            <div className="flex gap-[46px] mt-[28px]">
                ...
                <button
                    ...
                    className={`flex py-[8px] px-[18px] text-center font-medium rounded-xl border-2 border-[#d2b4e7]/80 transition-all duration-200 hover:border-[#B13BFF] ${activeTab === "tab5"
                        ? "bg-[#B13BFF] text-[#090040] border-[#B13BFF]  font-medium"
                        : "text-[#fff]/80 hover:border-[#d2b4e7]"
                        }`}
                >
            ...
            <div className="mt-[28px] p-4">
                ...
                {activeTab === "tab1" && (
                    <div className="grid grid-cols-4 gap-[16px]">
                        <span className="flex flex-row items-center gap-[14px] text-[16px] font-medium border-2 border-[#fff]/20 hover:border-green-500/80 dark:border-primary/20 dark:hover:border-red-500/80 shadow-xl shadow-[#fff]/0 dark:hover:shadow-red-500/10 px-4 py-[16px] rounded-xl w-[240px] bg-[#fff]/2 dark:bg-primary/2.5 transition-colors duration-300 dark:hover:text-red-100 text-[#fff]/80 hover:shadow-green-500/10 hover:text-green-800">
                            <FaReact size={28} />
                            React.js
                        </span>
